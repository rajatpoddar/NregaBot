...
def load_icons():
    ...
    Updated to match new assets in assets/icons/emojis/
    """
    icons = {}
    ...
    # FIX: Key renamed to match tab_config (was emoji_work_alloc)
    _add("emoji_work_allocation", "assets/icons/emojis/work_allocation.png", size=(16, 16)) 
    ...
    _add("emoji_material_entry", "assets/icons/emojis/material_entry.png", size=(16, 16))
    
    
    # 2. JE & AE Approval
    # FIX: Key renamed (emoji_emb_entry -> emoji_mb_entry) and path updated (warning.png -> mb_entry.png)
    _add("emoji_mb_entry", "assets/icons/emojis/mb_entry.png", size=(16, 16))
    ...
    _add("emoji_del_demand", "assets/icons/emojis/del_demand.png", size=(16, 16))
    _add("emoji_delete_applicant", "assets/icons/emojis/del_applicant.png", size=(16, 16))
    ...
    _add("emoji_tools", "assets/icons/emojis/emoji_tools.png", size=(16, 16)) 

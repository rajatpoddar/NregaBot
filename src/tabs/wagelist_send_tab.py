...
class WagelistSendTab(BaseAutomationTab):
    ...
    def _create_widgets(self) -> None:
        ...
        self._create_header_card(self, "📤", tr("tab.wagelist_send.title"), tr("tab.wagelist_send.subtitle"),
        ...
        ctk.CTkLabel(settings_container, text=tr("common.financial_year")).grid(row=0, column=0, padx=(15, 5), pady=15, sticky="w")
    ...
    def start_automation(self) -> None:
        ...
        if not fin_year:
            messagebox.showerror(tr("errors.input_error"), tr("dialogs.select_fin_year"))
            return
    ...
    def populate_wagelist_data(self, wagelists):
        ...
        if count:
            self.mode_label.configure(
                text=tr("form.wagelist_send.will_send", count=count),
    ...
    def retry_logic_handler(self) -> None:
        ...
        """
        if messagebox.askyesno(tr("base.error_tab.retry_btn"), tr("dialogs.retry_wagelists")):
        ...
        try:
            ...
            if specific_wagelists:
                ...
                if not matched:
                    ...
                    messagebox.showwarning(tr("dialogs.no_wagelists"), tr("dialogs.wl_not_in_dropdown"))
                    return

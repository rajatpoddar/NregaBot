...
<p align="center">
  <b>Version 2.8.3.4 | Now with Smart Updates, Calendar UI, and Enhanced Stability!</b><br />
...
- **For Windows**: `NREGABot-v2.8.3.4-Setup.exe`
- **For macOS**: `NREGABot-v2.8.3.4-macOS.dmg`

...
<img src="assets/logo.png" alt="NREGA Bot" width="110"/>

# 🚜 NREGA Bot

**v3.2.13** — Powerful NREGA Automation for Windows, macOS & Linux

[![Version](https://img.shields.io/badge/version-3.2.13-1F4E79?style=flat-square)](https://nregabot.com/#downloads)
...
[![Stars](https://img.shields.io/github/stars/rajatpoddar/NregaBot?style=flat-square)](https://github.com/rajatpoddar/NregaBot)
[![License](https://img.shields.io/badge/license-Proprietary-red?style=flat-square)](https://nregabot.com/buy)
...
<img src="assets/screenshots/Muster_Roll_Generator.png" width="700"/><br/>
<em>Muster Roll Generator — modern, intuitive dashboard</em>

<br/><br/>

<img src="assets/screenshots/Duplicate_MR_Print.png" width="700"/><br/>
<em>Duplicate MR Print — find, print & merge muster rolls</em>

<br/><br/>

<img src="assets/screenshots/MR_Tracking.png" width="700"/><br/>
<em>MR Tracking — pendency T0–T8 reports & Zero MR forwarding</em>

<br/><br/>

<img src="assets/screenshots/Dashboard_Report.png" width="700"/><br/>
<em>Dashboard Report — comprehensive views with full export</em>

<br/><br/>

<img src="assets/screenshots/Demand_Automation.png" width="700"/><br/>
<em>Demand Automation — bulk labour demand from CSV</em>

<br/><br/>

<img src="assets/screenshots/eMB_entry.png" width="700"/><br/>
...
> 🔧 **For developers:** the full architecture guide, entry points and build scripts live in the [🧑💻 Developer Guide](#-developer-guide-architecture) section at the bottom. AI agents: `AGENTS.md` is the compact operating manual to read first.
...
<details>
<summary><b>🕐 Can I use my PC while an automation runs?</b></summary>
...
<details>
<summary><b>📱 Do I get WhatsApp reports?</b></summary>
...
<details>
<summary><b>💻 I have a low-end PC — will it work?</b></summary>
...
> This section is the technical reference for developers who work on the NREGA Bot source.
> **AI agents:** har session start pe `AGENTS.md` padho — wo compact operating manual hai
> (quick-start, golden rules, task→file map). Neeche ka section deep dive ke liye hai.

<details>
<summary><b>📐 Click to expand — full codebase architecture guide</b></summary>
...
> ⚠️ **TWO repos:** ye desktop app repo hai. `nrega-server/` ek **alag independent repo**
> hai (self-hosted NAS git: `ssh://rajat@192.168.29.101:/volume1/docker/nrega-server.git`,
> branch `master`) — submodule nahi, main repo use ignore karta hai (`.gitignore`).
> Desktop = GitHub push; Server = NAS push + `deploy.sh`. Dono alag se ship hote hain.
...
- **~55 tabs**, each a `ctk.CTkFrame`. Config lives in `src/tab_config.py`
...
dash_report, mis_reports, issued_mr_report, ekyc_report, social_audit_respond,
...
- `APP_VERSION` (3.2.2), `LICENSE_SERVER_URL` (env or default), `MAIN_WEBSITE_URL`,
